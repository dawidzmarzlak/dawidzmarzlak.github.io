...
if ( ! bean_and_brew_is_section_visible( 'location' ) ) {
    return;
}

$directions_url = bean_and_brew_text( 'location_directions_url' );
?>
...
<section id="visit" class="wp-block-group cafe-location has-beige-background-color has-background" style="padding-top:6rem;padding-right:1rem;padding-bottom:6rem;padding-left:1rem">
    ...
    <div class="wp-block-columns are-vertically-aligned-center">
        ...
        <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%">
            ...
            <div class="cafe-location__map" aria-hidden="true">
                ...
                <div class="cafe-location__map-pin">
                    ...
                    <p><?php echo esc_html( bean_and_brew_text( 'location_map_pin_text' ) ); ?></p>
                </div>
            </div>
            <!-- /wp:html -->
        </div>
        ...
        <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%">
            ...
            <h2 class="wp-block-heading has-espresso-color has-text-color has-xx-large-font-size" style="font-family:&quot;DM Serif Display&quot;, Georgia, serif"><?php echo esc_html( bean_and_brew_text( 'location_title' ) ); ?></h2>
            <!-- /wp:heading -->

            <!-- wp:list {"className":"cafe-location__info"} -->
            <ul class="wp-block-list cafe-location__info">
                <li><strong>Address</strong><br><?php echo esc_html( bean_and_brew_text( 'location_address' ) ); ?></li>
                <li><strong>Hours</strong><br><?php echo esc_html( bean_and_brew_text( 'location_hours' ) ); ?></li>
            </ul>
            <!-- /wp:list -->

            <!-- wp:buttons -->
            <div class="wp-block-buttons">
                <!-- wp:button {"backgroundColor":"espresso","textColor":"cream","url":"<?php echo esc_attr( $directions_url ); ?>","style":{"border":{"radius":"9999px"}}} -->
                <div class="wp-block-button"><a class="wp-block-button__link has-cream-color has-espresso-background-color has-text-color has-background wp-element-button" style="border-radius:9999px" href="<?php echo esc_url( $directions_url ); ?>">Get Directions</a></div>
                <!-- /wp:button -->
            </div>
            <!-- /wp:buttons -->
