...
<section class="wp-block-group cafe-cta has-cream-background-color has-background" style="padding-top:5rem;padding-right:1rem;padding-bottom:5rem;padding-left:1rem">
    ...
    <h2 class="wp-block-heading has-text-align-center has-espresso-color has-text-color has-xx-large-font-size" style="font-family:&quot;DM Serif Display&quot;, Georgia, serif">Come share a cup with us</h2>
    <!-- /wp:heading -->

    <!-- wp:paragraph {"align":"center","style":{"typography":{"fontFamily":"\"Caveat\", cursive","fontSize":"1.75rem"}},"textColor":"clay"} -->
    <p class="has-text-align-center has-clay-color has-text-color" style="font-family:&quot;Caveat&quot;, cursive;font-size:1.75rem">Stop by, slow down, stay a while.</p>
    <!-- /wp:paragraph -->

    <!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
    <div class="wp-block-buttons">
        <!-- wp:button {"backgroundColor":"clay","textColor":"cream","style":{"border":{"radius":"9999px"}}} -->
        <div class="wp-block-button"><a class="wp-block-button__link has-cream-color has-clay-background-color has-text-color has-background wp-element-button" style="border-radius:9999px" href="#visit">Visit Us</a></div>
        <!-- /wp:button -->
    </div>
    <!-- /wp:buttons -->
