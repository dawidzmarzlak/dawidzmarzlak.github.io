  ...
  return (
    <section className="max-w-[1400px] mx-auto px-5 lg:px-9 py-20">
      ...
      <div className="ab-bento">
        ...
        {/* Cell 2 — stat 1 */}
        <div className="bg-bg-card text-fg rounded-[24px] p-7 flex flex-col">
        ...
        {/* Cell 5 — stat 3 (lime accent) */}
        <div className="bg-accent text-accent-fg rounded-[24px] p-7 flex flex-col">
